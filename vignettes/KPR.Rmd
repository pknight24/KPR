...
Estimating the parameters $\beta$ and $\eta$ yields the following optimization problem:
...
$\mathbf{H}$ denotes the $n \times n$ sample kernel, and
$\mathbf{Q}$ denotes the $p \times p$ parameter kernel. Note that $n$
represents the number of samples, $p$ the number of penalized parameters, and $r$ the number of
